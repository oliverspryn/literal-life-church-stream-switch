...
Vue.component('stream-switch', {
    ...
    methods: {
        selectedAudio: function() {
            var audio = audioUrl + '(format=m3u8-aapl-v3)';
        ...
        selectedVideo: function() {
            var video = videoUrl + '(format=m3u8-aapl-v3)';
    ...
    mounted: function () {
        ...
        axios.get(url)
            .then(function (response) {
                ...
                this.showSwitcherControls = true;
